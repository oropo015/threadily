    ...
    <div className="flex-1">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Get insights on how to <strong>improve your content's performance</strong> with readability scores and
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Easily add and optimize images for your threads to <strong>create visually appealing content</strong>{" "}
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Get recommendations for the <strong>best times to post</strong> your content based on platform-specific
                engagement patterns.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                "Threadify has <strong>revolutionized my workflow</strong>. I can now create a week's worth of Twitter
                threads in just an hour!"
              </p>
            </div>
      ...
      <section className="py-16 bg-blue-600 dark:bg-blue-800">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          {isClient && (
            <div className="mt-8">
              <p className="text-blue-100 mb-3">Share Threadify with your network:</p>
              <SocialShareButtons
                url="https://threadify.pro"
                title="Create perfect social media threads with Threadify"
